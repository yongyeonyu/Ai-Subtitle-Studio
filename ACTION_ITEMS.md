...
Previous-Content: v03.00.43 액션아이템 파일/함수 힌트 작성 규칙 추가
This-Update: v03.00.43 앱 전체 구역 정렬/위젯 패널화 항목 추가
Copilot-Handoff: v03.00.43 기준. 현재 앱 버전은 config.py APP_VERSION 03.00.43입니다. 앱 전체 화면을 사이드바/에디터/미리보기/타임라인/하단 메뉴/로그/큐 구역으로 정렬하고 각 위젯 영역을 둥근 모서리 패널로 통일하는 UI 항목을 ACTION_ITEMS.md와 check_list.md에 추가했습니다. 다음 우선순위는 BUG-STT1 생성 중 STT Mode 전환 확인/재시작입니다.
-->
