...
4. Before any collect-cache default review, fix or explicitly owner-accept the real-media first-180s final tail-bound failure: the latest run proves cache speed but fails strict acceptance only because final last end `180.256s` exceeds the current duration bound plus slack by `0.006s`.
