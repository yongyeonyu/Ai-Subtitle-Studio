...
[![App Version](https://img.shields.io/badge/app-04.00.18-0A84FF?style=for-the-badge)](#)
[![Release](https://img.shields.io/badge/release-v04.00.18-30D158?style=for-the-badge)](RELEASE_v04.00.18.md)
...
| Handoff document version | `04.00.18-source-app` |
| Active phase | `SOURCE_APP_CONTINUATION_V4_0_18` |
...
The current release checkpoint is [`RELEASE_v04.00.18.md`](RELEASE_v04.00.18.md). The repository keeps only the most recent release notes needed for handoff continuity, and the five handoff documents should summarize only the current state plus the immediately previous release relationship.
