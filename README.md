...
[![App Version](https://img.shields.io/badge/app-03.17.00-0A84FF?style=for-the-badge)](#)
[![Release](https://img.shields.io/badge/release-v03.17.00-30D158?style=for-the-badge)](RELEASE_v03.17.00.md)
...
Current development is now in PHASE3 personalization. The current release adds ground-truth import, learned subtitle-rule extraction, settings and prompt trial scoring, idle training orchestration, runtime personalization overrides, and the related queue/timeline cleanup needed to apply those results across the shared processing pipeline.
...
- Subtitle video output after subtitle generation when enabled.
...
| Item | Value |
| --- | --- |
| App version in code | `03.17.00` |
| Latest release checkpoint | `v03.17.00` |
| Handoff document version | `03.17.00` |
| Active phase | `PHASE3` |
...
The current release checkpoint is [`RELEASE_v03.17.00.md`](RELEASE_v03.17.00.md). Older release notes remain in the repository as history, but handoff documents should only summarize the latest state and the immediately previous release relationship.
