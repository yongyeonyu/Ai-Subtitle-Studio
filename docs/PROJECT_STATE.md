...
- App version: `04.01.00` from `core/runtime/config.py`
- Project schema version: `04.01.00` from `core/project/project_format.py`
- Latest source-app checkpoint: `docs/release_notes/RELEASE_v04.01.00.md`
- Latest source quick QA artifact: `output/manual_verification/latest/qa_suite_quick_v040100_20260628`
- Latest App Store readiness audit: `output/manual_verification/latest/app_store_readiness_v040100_20260628/app_store_readiness_audit.md`

`v04.01.00` is a source-app release checkpoint, not App Store submission proof.
...
parity, trace-bundle retention, and `v04.01.00` source release proof.
