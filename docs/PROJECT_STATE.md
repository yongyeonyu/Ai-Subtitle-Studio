...
- App version: `04.01.02` from `core/runtime/config.py`
- Project schema version: `04.01.02` from `core/project/project_format.py`
- Latest source-app checkpoint: `docs/release_notes/RELEASE_v04.01.02.md`
...
`v04.01.02` is a source-app release checkpoint, not App Store submission proof.
...
parity, trace-bundle retention, and `v04.01.02` source release proof.
