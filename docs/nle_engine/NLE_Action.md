...
<!--
Document-Version: 04.01.09-nle-action
...
- Latest G3/G2 final-overlap deferred-save retry guard: `v04.01.09` treats `nle_save_export_final_overlap` as a nonretryable deferred project-save error, clears stale pending deferred-save snapshots, and avoids repeated retry timers while preserving ordinary writer retries. The final-overlap guard remains strict and the underlying final subtitle overlap still blocks same-media save/reopen/final-export acceptance.
