...
- `docs/planning_queue/ACTION_ITEMS.md` 실행 또는 새 아이디어 발굴 전에 반드시 이 파일과 `docs/planning_queue/waste_action_item.md`를 먼저 확인한다.
...
- 완료된 `docs/planning_queue/ACTION_ITEMS.md` 항목을 다시 실행하라는 요청이 오면 폐기 후보를 새 근거 없이 재구현하지 않는다.
