<!--
Document-Version: 04.01.20-codemap
...
- `tools/audit_nle_persistence_cutover.py`: G2 NLE persistence audit; includes explicit top-level `nle` compatibility projection while default project load remains legacy-owned.
