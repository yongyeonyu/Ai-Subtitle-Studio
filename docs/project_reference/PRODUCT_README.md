...
[![App Version](https://img.shields.io/badge/app-04.01.06-0A84FF?style=for-the-badge)](#)
[![Release](https://img.shields.io/badge/release-v04.01.06-30D158?style=for-the-badge)](../release_notes/RELEASE_v04.01.06.md)
...
- G3 live NLE runtime observability can be verified through `tools/remote_verify.py live-nle-proof`, which records compact `guided-subtitle-status` samples and optional existing-window snapshots without adding a new visible UI lane or exposing raw STT/VAD row text.
...
| Handoff document version | `04.01.06-source-app` |
...
The current release checkpoint is [`RELEASE_v04.01.06.md`](../release_notes/RELEASE_v04.01.06.md). The repository keeps only the most recent release notes needed for handoff continuity, and the five handoff documents should summarize only the current state plus the immediately previous release relationship.
