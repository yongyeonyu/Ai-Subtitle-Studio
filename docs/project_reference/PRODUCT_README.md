...
[![App Version](https://img.shields.io/badge/app-04.01.29-0A84FF?style=for-the-badge)](#)
[![Release](https://img.shields.io/badge/release-v04.01.29-30D158?style=for-the-badge)](../release_notes/RELEASE_v04.01.29.md)
...
| Handoff document version | `04.01.29-source-app` |
...
The current release checkpoint is [`RELEASE_v04.01.29.md`](../release_notes/RELEASE_v04.01.29.md). The repository keeps only the most recent release notes needed for handoff continuity, and the five handoff documents should summarize only the current state plus the immediately previous release relationship.
