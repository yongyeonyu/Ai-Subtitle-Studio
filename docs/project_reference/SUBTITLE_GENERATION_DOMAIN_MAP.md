...
- Native helper seams already present: `core/native_subtitle_segments.py`,
  ...
  `native/macos/AIStudioNative/Sources/AIStudioCore/SubtitleSegmentsSummary.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/SubtitleSTTSegmentsSummary.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/SubtitleTimingMetrics.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/SubtitleWaveformSummary.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/SubtitleGlobalCanvasSummary.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/SubtitleResourcePlan.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/SubtitleLoraSelectiveMerge.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/STTDurationFirstOrder.swift`,
  `native/macos/AIStudioNative/Sources/AIStudioCore/AudioFastFlattenFilter.swift`.
...
- Native candidates: `core/native/_native_subtitle_resource.cpp` and
  `SubtitleResourcePlan.swift` for summaries; scheduling ownership stays in
  Python.
