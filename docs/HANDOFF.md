...
- Next NLE release-source candidate from Jammini scout is diamond drag delete in `ui/editor/ux/editor_timeline_segment_merge.py`; handle it separately because it is a delete-plus-resize atomicity problem, not a simple text/speaker edit.
