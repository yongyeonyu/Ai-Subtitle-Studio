...
- Next NLE action is commit-boundary mutable timeline sync. Do not write NLE mutable state on every drag pixel; only reconcile at release/commit boundaries after proving Taption drag, magnet, gap, and neighbor-reorder behavior again.
