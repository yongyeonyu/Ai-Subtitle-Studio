...
앱 버전 기준: `04.00.17`
기본 실행 모드: High
녹음 상황 기록: `docs/quality_validation/NAS_SUBTITLE_BENCHMARK_RECORDING_CONTEXT.md`
...
8. `docs/quality_validation/NAS_SUBTITLE_BENCHMARK_RECORDING_CONTEXT.md`에서 owner-confirmed 녹음 상황 태그를 읽어 상황별 원인 후보를 함께 기록
