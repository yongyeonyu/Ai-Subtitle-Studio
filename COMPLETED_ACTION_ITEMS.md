...
15. Persisted NLE project fields remain gated, remaining commit-boundary mutable timeline sync stays active, and broader persistence/save/render/export ownership cleanup remains gated.
