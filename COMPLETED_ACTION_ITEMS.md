...
14. Persisted NLE project fields remain gated, commit-boundary mutable timeline sync remains active, and broader persistence/save/render/export ownership cleanup remains gated.
