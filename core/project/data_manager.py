...
def load_settings() -> dict:
    ...
    materialized = materialize_user_settings(merged_settings)
    try:
        if user_settings != materialized:
            save_settings(materialized)
    except Exception:
        pass

    return apply_accuracy_first_runtime_settings(materialized)
