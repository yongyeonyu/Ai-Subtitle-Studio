...
RUNTIME_SETTING_KEYS = set(LORA_AUTO_MANAGED_SETTING_KEYS) | {
    ...
    "lora_retrieval_skip_large_runtime_index",
    "lora_retrieval_runtime_max_index_mb",
    "lora_gpu_acceleration_enabled",
    "lora_gpu_prefer_mps",
    "lora_gpu_retrieval_scoring_enabled",
    "lora_gpu_retrieval_min_postings",
    "lora_gpu_force_small_batches",
