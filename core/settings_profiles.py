...
UI_ENGINE_DEFAULTS: dict[str, Any] = {
    ...
    "live_stt_npu_prefer_enabled": False,
...
CUT_BOUNDARY_DEFAULTS: dict[str, Any] = {
    ...
    "scan_cut_follower_use_preview_proxy_enabled": False,
    "scan_cut_cv2_video_backend": "avfoundation",
    "scan_cut_follower_cv2_video_backend": "default",
    ...
    "scan_cut_live_native_coarse_min_regions": 2,
    "scan_cut_live_native_coarse_region_threshold": 24.0,
    "scan_cut_live_native_coarse_diff_threshold": 32.0,
...
LORA_AUTO_MANAGED_SETTING_KEYS = frozenset(
    {
        ...
        "scan_cut_follower_use_preview_proxy_enabled",
        "scan_cut_follower_cv2_video_backend",
        ...
        "scan_cut_live_visual_enabled",
        "scan_cut_live_native_coarse_enabled",
        "scan_cut_live_native_coarse_min_regions",
        "scan_cut_live_native_coarse_region_threshold",
        "scan_cut_live_native_coarse_diff_threshold",
        "scan_cut_live_visual_max_sec",
        "scan_cut_live_visual_coarse_max_sec",
        "scan_cut_live_visual_coarse_stride_frames",
        "scan_cut_live_visual_coarse_width",
        "scan_cut_live_visual_candidate_topk",
        "scan_cut_live_visual_candidate_min_score",
        "scan_cut_live_visual_follower_verify_enabled",
        "scan_cut_live_visual_width",
        "scan_cut_live_visual_refine_width",
        "scan_cut_live_visual_refine_radius",
        "scan_cut_live_visual_min_edge_residual",
        "scan_cut_live_visual_min_edge_diff",
        "scan_cut_live_visual_min_residual_ratio",
        "scan_cut_live_visual_min_motion_jump",
        "scan_cut_live_visual_abs_motion_px",
        "scan_cut_live_visual_max_coherence",
        "scan_cut_live_visual_min_score",
        "scan_cut_live_visual_peak_ratio",
        "scan_cut_live_visual_peak_margin",
