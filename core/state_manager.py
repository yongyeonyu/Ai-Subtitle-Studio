...
class SubtitleStateManager(QObject):
    ...
    def start_ai_all(self):
        ...
        self._broadcast()
        self._send_ntfy("🎙️ AI PD Studio", "자막 생성을 시작합니다.")
    ...
    def start_partial_segment(self):
        ...
        self._broadcast()
        self._send_ntfy("🎙️ AI PD Studio", "구간 재생성을 시작합니다.")
    ...
    def start_partial_from_here(self):
        ...
        self._broadcast()
        self._send_ntfy("🎙️ AI PD Studio", "이어서 전체 재생성을 시작합니다.")
    ...
    def start_auto_mode(self):
        ...
        self._broadcast()
        # self._send_ntfy("☁️ AI PD Studio", "iCloud 자동 처리를 시작합니다.")
    ...
    def stop_processing(self, msg="중지되었습니다."):
        ...
        self._broadcast()
        self._send_ntfy("⏹️ AI PD Studio", f"처리가 중단되었습니다: {msg}")
