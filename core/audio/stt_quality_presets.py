    ...
    profiles = {
        "fast": {
            ...
            **_decoder_settings(0.86, -1.0, 1.6, 0.0, 3, 1.0),
            ...
            "stt_low_score_recheck_threshold": 64,
            "stt_low_score_recheck_padding_sec": 0.45,
            "stt_low_score_recheck_max_segments": 8,
            "stt_low_score_recheck_max_audio_sec": 45.0,
