...
class EditorTimelineDragReleaseTests(unittest.TestCase):
    ...
    def test_left_handle_full_merge_can_delete_previous_segment_via_menu_choice(self):
        editor = self._make_editor([
            {"start": 0.0, "end": 1.0, "text": "삭제될 앞 자막", "speaker": "00"},
