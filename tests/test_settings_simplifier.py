...
class SettingsSimplifierTests(unittest.TestCase):
    def test_apply_simple_operation_mode_forces_autopilot_controls(self):
        ...
        self.assertEqual(settings["simple_operation_mode"], "balanced")
    ...
    def test_operation_mode_aliases_and_items_are_stable(self):
        ...
        self.assertEqual(normalize_simple_operation_mode("accuracy"), "precise")
        self.assertEqual([item[0] for item in simple_operation_mode_items()], ["auto", "fast", "balanced", "precise"])
