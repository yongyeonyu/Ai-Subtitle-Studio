...
class RoughcutDetailMixin:
    ...
    def _build_detail_panel(self) -> QWidget:
        ...
        edit_header_row = QHBoxLayout()
        edit_header_row.setContentsMargins(0, 0, 0, 0)
        edit_header_row.setSpacing(6)
        edit_title = QLabel("컷 조정")
        edit_title.setStyleSheet(label_style("muted", 10, bold=True))
        edit_header_row.addWidget(edit_title)
        ...
        self.cut_action_combo.setMinimumWidth(96)
        self.cut_action_combo.setStyleSheet(self._detail_input_style())
        edit_header_row.addWidget(self.cut_action_combo)
        edit_header_row.addStretch(1)
        ...
        edit_header_row.addWidget(self.btn_apply_cut_edit)
        ...
        edit_header_row.addWidget(self.btn_revert_user_edit)
        lay.addLayout(edit_header_row)
        ...
        for label_text, spinbox in (("In", self.cut_trim_start_spin), ("Out", self.cut_trim_end_spin)):
            ...
            trim_row.addWidget(lbl)
            trim_row.addWidget(spinbox, stretch=1)
