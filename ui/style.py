...
def settings_button_style(kind="toolbar", *, font_size="12px", min_width=72, min_height=40):
    ...
    return (
        ...
        "} "
        f"QPushButton:hover {{ background: {hover}; border-color: #5A6A76; }} "
        "QPushButton:pressed { background: #0B345E; border-color: #D7EBFF; padding-top: 1px; padding-bottom: 0; } "
...
def tool_button_style(kind="toolbar", *, checked=False, padding: str = "6px 8px"):
    ...
    return (
        "QToolButton { "
        f"background: {bg}; color: {color}; border: 1px solid {border}; "
        f"border-radius: 10px; padding: {padding}; font-size: 11px; font-weight: 700; "
        "} "
        f"QToolButton:hover {{ background: {COLORS['control_hover']}; border-color: #5A6A76; }} "
        "QToolButton:pressed { background: #0B345E; border: 2px solid #D7EBFF; padding-top: 7px; padding-bottom: 5px; } "
...
def settings_dialog_stylesheet():
    return (
        f"QDialog {{ background: {COLORS['bg']}; color: {COLORS['text']}; font-size: 12px; }}"
        ...
        f"border: 1px solid {COLORS['separator']}; border-radius: 10px; "
        "padding: 5px 8px; selection-background-color: #2E75D4; "
        "}"
        ...
        f"border: 1px solid {COLORS['separator']}; border-radius: 10px; padding: 4px; selection-background-color: #1F3A56; }}"
        f"QPushButton {{ background: {COLORS['control']}; color: {COLORS['text']}; "
        f"border: 1px solid {COLORS['separator']}; border-radius: 10px; "
        "padding: 5px 10px; font-weight: 700; min-height: 26px; min-width: 62px; }"
        f"QPushButton:hover {{ background: {COLORS['control_hover']}; border-color: #5A6A76; }} "
        ...
        "QPushButton:disabled { color: #6F767D; background: #151A1E; border-color: #222A31; }"
        f"QCheckBox {{ color: {COLORS['text']}; background: transparent; spacing: 7px; }}"
        f"QCheckBox::indicator {{ width: 14px; height: 14px; border: 1px solid #64717B; "
        "border-radius: 5px; background: #10161A; }"
        ...
        f"QTabWidget::pane {{ border: 1px solid {COLORS['separator']}; border-radius: 12px; top: -1px; "
        f"background: {COLORS['surface']}; }}"
        f"QTabBar::tab {{ background: {COLORS['control']}; color: {COLORS['muted']}; "
        f"border: 1px solid {COLORS['separator']}; border-bottom: none; padding: 7px 12px; "
        "min-height: 24px; min-width: 64px; border-top-left-radius: 10px; border-top-right-radius: 10px; }"
        ...
        f"QGroupBox {{ border: 1px solid {COLORS['separator']}; border-radius: 12px; margin-top: 10px; "
        f"padding: 10px 8px 8px 8px; background: {COLORS['surface']}; }}"
