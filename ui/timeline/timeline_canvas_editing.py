...
from PyQt6.QtGui import QAction, QFont, QTextCursor, QTextOption
...
from ui.timeline.timeline_constants import HANDLE_R, SUBTITLE_BOT, SUBTITLE_TOP, _build_gaps


NEW_SUBTITLE_PLACEHOLDER = "새자막"
SUBTITLE_SEGMENT_FONT_PT = 11
...
class TimelineInlineEditMixin:
    ...
    def _ensure_inline_editor(self):
        ...
        if editor is None:
            editor = _TimelineInlineTextEdit(self)
