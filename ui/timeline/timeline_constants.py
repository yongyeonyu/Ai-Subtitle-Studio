...
SUBTITLE_LANE_H = 52
SUBTITLE_BOT = SUBTITLE_TOP + SUBTITLE_LANE_H
SCORE_TOP = SUBTITLE_TOP - 18
SCORE_BOT = SUBTITLE_TOP - 2
SCORE_H = SCORE_BOT - SCORE_TOP
STT1_TOP = SUBTITLE_BOT + 2
STT1_BOT = STT1_TOP + (SUBTITLE_BOT - SUBTITLE_TOP)
STT2_TOP = STT1_BOT
STT2_BOT = STT2_TOP + (SUBTITLE_BOT - SUBTITLE_TOP)
STT_PREVIEW_VERTICAL_INSET = 0
SPEAKER_TOP = STT2_BOT + 4
SPEAKER_BOT = SPEAKER_TOP + 24
VOICE_ACTIVITY_TOP = SPEAKER_BOT
VOICE_ACTIVITY_BOT = VOICE_ACTIVITY_TOP + 8
...
ANALYSIS_TOP = VOICE_ACTIVITY_BOT
ANALYSIS_BOT = ANALYSIS_TOP
CANVAS_H = VOICE_ACTIVITY_BOT
SEG_BOT = CANVAS_H
SEG_H = SEG_BOT - SEG_TOP
DIAMOND_Y = SCORE_TOP + (SCORE_H // 2)
