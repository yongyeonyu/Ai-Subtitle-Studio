...
# 교정사전 및 규칙 파일 경로
CORRECTIONS_DIR  = os.path.join(BASE_DIR, "dataset")
CORRECTIONS_FILE = os.path.join(DATASET_DIR, "dataset_correction.json")
RULES_FILE       = os.path.join(BASE_DIR, "dataset", "subtitle_rule.json")

# iCloud 드롭존
ICLOUD_DROPZONE = os.path.expanduser("~/Library/Mobile Documents/com~apple~CloudDocs/AI_EDIT")

# ── 🎙️ Whisper 및 오디오 설정 ──
WHISPER_MODEL = "mlx-community/whisper-large-v3-mlx"
LANGUAGE = "ko"
TIME_OFFSET = 0.2
DEFAULT_FOLDER = "/Volumes/photo/25_유튜브영상_미완성"
...
# ── 🔔 ntfy 푸시 알람 설정 ──
# ntfy.sh 토픽명을 설정하면 주요 상태 변경 시 알람이 전송됩니다.
# 예: NTFY_TOPIC = "my_aipd_alerts"
# 비워두면 알람이 비활성화됩니다.
NTFY_TOPIC = "AI Subtitle Studio"
...
# ── 📏 자막 분리 기본 규칙 ──
DEFAULT_SPLIT_RULES = ["는데","은데","지만","하지만","어서","아서","가지고","해서","하고","이고","면서","니까","거든","잖아","있습니다","습니다"]
